...
function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Ürünleri:</td><td><a title="Icerik" href="/Admin/Product/ProductList/' + aData[1] + '">' + aData[2] + '</a></td></tr>';
    sOut += '<tr><td>Detay:</td><td><a title="Detay" href="/Admin/Category/CategoryList/' + aData[1] + '">' + aData[2] + '</a></td></tr>';
    sOut += '</table>';
